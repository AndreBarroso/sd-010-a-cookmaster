...
Continuando o meu aprendizado em Node JS, pude solidificar meus  conhecimentos relativos ao desenvolvimento de APIs utilizando o padrão REST e a arquitura MSC. Aprendi mais sobre os conceitos de token e autenticação. Como fazer upload de arquivos e adicionar seus dados em bancos de dados.

Esse projeto teve como objetivo, criar uma API que desse a possibilidade de fazer o cadastro e login de pessoas usuárias, onde apenas essas pessoas podessem acessar, modificar e deletar as receitas que elas cadastraram.
...
```bash
git clone https://github.com/AndreBarroso/sd-010-a-cookmaster.git
```
